...
import com.loser.game.bubblefire.render.GridLevel;
import com.loser.game.bubblefire.render.Level;
import com.loser.game.bubblefire.render.Player;
import com.loser.game.bubblefire.render.StartView;
...
public class MainStage extends Stage {
	...
	public MainStage(IActivityRequestHandler iActHandler) {
		super(new ScalingViewport(Scaling.fillX, VP_WIDTH, VP_HEIGHT,	new OrthographicCamera(VP_WIDTH, VP_HEIGHT)));
